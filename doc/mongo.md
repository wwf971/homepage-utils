...
| PATCH | `/mongo/db/{dbName}/coll/{collName}/docs/{docId}/update` | Update document. Body: `{action: "setValue", path: "field.path", value: any}`. Actions: setValue, deleteField, replaceFields |
