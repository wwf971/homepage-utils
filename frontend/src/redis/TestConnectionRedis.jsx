...
export const TestConnectionRedis = () => {
  const [testing, setTesting] = useState(false);
  const [result, setResult] = useState(null);
  const config = useAtomValue(redisComputedConfigAtom);
  ...
  const handleTest = async () => {
    ...
    try {
      ...
      const response = await fetch(`${backendUrl}/redis/test/`, { 
        method: 'POST',
  ...
  return (
    <div className="main-panel">
      <div className="panel-title">Test Redis Connection (Direct)</div>
      ...
      <div className="test-action-section">
        <div className="test-description">Click the button below to test the Redis connection directly using the above configuration.</div>
...
export default TestConnectionRedis;
